...
As mentioned above, most of the ICs are available in DIP (through-hole) packages, and I have been using them for prototyping on the breadboard (fig. \ref{fig:breadboard}).
